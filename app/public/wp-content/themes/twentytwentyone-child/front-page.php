    ...
    <section class="blocks-container">
        ...
        <div class="background-image"></div> 
            <div class="content">
                ...
                <p>Le projet "Améliorez le site d'un studio d'animation avec JavaScript et des animations CSS", sert à découvrir différentes animations possibles avec les outils cités. L'opportunité de découvrir une partie des choses que l'on peut produire en front-end.</p>
            </div>
        </div>
        ...
        <div class="background-image"></div> 
            <div class="content">
                ...
                <p>Le projet "Créez un site WordPress complexe pour une photographe freelance". Un projet complexe où on apprend à créer un site entier avec entre autre, une personnalisation de l'interface de wordpress, et Ajax.</p>
            </div>
        </div>
    </section>
</main>
